...
const nav = [
  ...
  { href: "/automation", label: "Otomasyon", icon: AutomationIcon },
  { href: "/webhooks", label: "Webhook", icon: WebhookIcon },
  { href: "/scheduled-reports", label: "Zamanlanmış Raporlar", icon: CalendarIcon },
  { href: "/analytics-advanced", label: "Gelişmiş Analytics", icon: AnalyticsAdvancedIcon },
  { href: "/audiences", label: "Audience Yönetimi", icon: AudienceIcon },
  { href: "/competitor", label: "Rakip Analizi", icon: CompetitorIcon },
  { href: "/ai-advanced", label: "AI Geliştirmeleri", icon: AIAdvancedIcon },
  { href: "/campaign-templates", label: "Kampanya Şablonları", icon: CampaignTemplateIcon },
  { href: "/cloud-export", label: "Cloud Export", icon: CloudExportIcon },
  { href: "/security", label: "Güvenlik", icon: ShieldIcon },
...
function AnalyticsAdvancedIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
    </svg>
...
function AIAdvancedIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function CampaignTemplateIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function CloudExportIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
